...
// find all intersections given multiple street IDs
std::vector<unsigned> find_all_intersections_given_multiple_street_IDs(std::vector<unsigned> const & streetIDsVec);

std::vector<unsigned> find_same_intersections(std::vector<unsigned> &intersections1,
        std::vector<unsigned> &intersections2);

std::pair<double,unsigned> find_closest_POI_one_interval(LatLon my_position, int x_value, int y_value);

std::pair<double, unsigned> find_closest_Intersection_one_interval(LatLon my_position, int x_value, int y_value);