...
extern vector<DeliveryNode> InterSecOrder;
...
//greedy algorithm to find a relatively good path
std::vector<unsigned> greedy_algorithm(const std::vector<DeliveryInfo> deliveries, const std::vector<unsigned> depots);

//a helper function to complete greedy_algorithm
std::vector<unsigned> find_path_between_two_ints(unsigned &intersect_id_start, const std::vector<DeliveryInfo>& deliveries, std::vector<unsigned> &CurrLoad, std::vector<unsigned> &pickedInt, int &NumOfVisitedNode);

//a helper function to complete greedy_algorithm
std::vector<unsigned> find_path_between_delivery_and_depot(unsigned intersect_id_start, const std::vector<unsigned> depots, std::vector<unsigned> &CurrLoad, std::vector<unsigned> &pickedInt) ;
